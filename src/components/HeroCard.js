...
export default function HeroCard(props) {
    ...
    return (
        <>
            <div className="w-full h-full relative bg-[#F7F9F7] rounded-xl p-4 md:p-8 flex flex-col justify-center items-center overflow-hidden">
                ...
                <div className="relative z-10 mt-4 bg-white p-4 rounded-md shadow-md">
                    <h3 className="text-left text-base md:text-lg font-normal text-gray-800">
                        {description}
                    </h3>
                </div>
            </div>
